...
namespace RayTrace
{
	MoveableD2DShow::MoveableD2DShow(int screenW, int screenH, IRender* render)
	{
		this->render = render;
		screenWidth = screenW;
	...
	void MoveableD2DShow::Pause()
	{
		//static_assert(false, "Unfinished");
	}

	void MoveableD2DShow::Resume()
	{
		//static_assert(false, "Unfinished");
	}

	void MoveableD2DShow::Stop()
	{
		//static_assert(false, "Unfinished");
	}
}